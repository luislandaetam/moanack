    ...
    <>
      {underMaintenance ? (
        <h1 className="h-screen">
          PÁGINA EN MANTENIMIENTO. DISPONIBLE EN LAS PRÓXIMAS HORAS
        </h1>
      ) : (
        <main>
          <article
          ...
          >
            <section className="col-start-2 my-[36rem]">
              ...
              <p className="mb-[2.5rem]">
                Descripción de quien es el Dr. Moanack, sus estudios y
                experiencia en el campo de la urología especial enfasis en la
                cirugia robotica.
              </p>
              <p>
